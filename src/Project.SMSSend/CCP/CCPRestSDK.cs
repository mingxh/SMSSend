...
namespace Project.SMSSend.CCP
{
    ...
    public class CCPRestSDK
    {
        ...
        public CCPResponseStatus QueryAccountInfo()
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
                return initError;
            }
            ...
            try
            {
                ...
                if (m_bodyType == EBodyType.EType_XML)
                {
                    ...
                    using (HttpWebResponse response = request.GetResponse() as HttpWebResponse)
                    {
                        ...
                        {
                            CCPResponseStatus responseResult = new CCPResponseStatus();
                ...
                else
                {
                    ...
                    using (HttpWebResponse response = request.GetResponse() as HttpWebResponse)
                    {
                        ...
                        if (responseStr != null && responseStr.Length > 0)
                        {
                            return JsonConvert.DeserializeObject<CCPResponseStatus>(responseStr);
                        }
        ...
        /// <exception cref="Exception"></exception>
        /// <returns>包体内容</returns>
        public CCPResponseStatus CreateSubAccount(string friendlyName)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
            ...
            try
            {
                ...
                using (HttpWebResponse response = request.GetResponse() as HttpWebResponse)
                {
                    ...
                    if (responseStr != null && responseStr.Length > 0)
                    {
                        ...
                        {
                            responseResult = JsonConvert.DeserializeObject<CCPResponseStatus>(responseStr);
                        }
        ...
        /// <exception cref="Exception"></exception>
        /// <returns></returns>
        public CCPResponseStatus GetSubAccounts(uint startNo, uint offset)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// <exception cref="Exception"></exception>
        /// <returns>包体内容</returns>
        public CCPResponseStatus QuerySubAccount(string friendlyName)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// <exception cref="Exception"></exception>
        /// <returns></returns>
        public CCPResponseStatus SendTemplateSMS(string to, string templateId, string[] data)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// <exception cref="Exception"></exception>
        /// <returns></returns>
        public CCPResponseStatus LandingCall(string to, string mediaName, string mediaTxt, string displayNum, string playTimes, int type, string respUrl)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// <exception cref="Exception"></exception>
        /// <returns></returns>
        public CCPResponseStatus VoiceVerify(string to, string verifyCode, string displayNum, string playTimes, string respUrl)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// <exception cref="Exception"></exception>
        /// <returns></returns>
        public CCPResponseStatus IvrDial(string number, string userdata, string record)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// <exception cref="Exception"></exception>
        /// <returns></returns>
        public CCPResponseStatus BillRecords(string date, string keywords)
        {
            CCPResponseStatus initError = paramCheckRest();
            if (initError != null)
            {
        ...
        /// </summary>
        /// <returns></returns>
        private CCPResponseStatus paramCheckRest()
        {
            int statusCode = 0;
        ...
        /// </summary>
        /// <returns></returns>
        private CCPResponseStatus paramCheckMainAccount()
        {
            int statusCode = 0;
            string statusMsg = null;
        ...
        /// </summary>
        /// <returns></returns>
        private CCPResponseStatus paramCheckSunAccount()
        {
            int statusCode = 0;
            string statusMsg = null;
        ...
        /// </summary>
        /// <returns></returns>
        private CCPResponseStatus paramCheckAppId()
        {
            if (m_appId == null)
            {
                return new CCPResponseStatus()
